class MedicalHistoriesController < ApplicationController
  ...
  def new
    @medical_history = MedicalHistory.new(medications: {},tb: {tb_smear: {}, tb_tx: {}, post_treatment_smear: {}}, hiv: {hiv_test: {}, arv_rx: {}, pmtct: {}, cd4: {}})
  end
  ...
  private
    ...
    def medical_history_params
      params.require(:medical_history).permit(:art_patient_id, medications: {}, known_drug_allergies: [], past_opportunistic_illness: [],
      tb: {}, hiv: {} )
    end
end
